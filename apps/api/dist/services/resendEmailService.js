 ...
 */
const getConsultantWelcomeEmailHtml = (data) => {
 ...
 */
const getPasswordResetEmailHtml = (data) => {
 ...
 */
const getConsultantApprovedEmailHtml = (data) => {
 ...
 */
const getConsultantRejectedEmailHtml = (data) => {
 ...
 */
const getClientWelcomeEmailHtml = (data) => {
 ...
 */
const getPaymentConfirmationEmailHtml = (data) => {
 ...
 */
const getRefundNotificationEmailHtml = (data) => {
 ...
 */
const getSessionConfirmationEmailHtml = (data) => {
 ...
 */
const getAdminNotificationEmailHtml = (data) => {
 ...
 */
const sendConsultantWelcomeEmail = async (data) => {
    try {
...
exports.sendConsultantWelcomeEmail = sendConsultantWelcomeEmail;
/**
 ...
 */
const sendSessionConfirmationEmail = async (data) => {
    try {
...
exports.sendSessionConfirmationEmail = sendSessionConfirmationEmail;
/**
 ...
 */
const sendConsultantApprovedEmail = async (data) => {
    try {
...
exports.sendConsultantApprovedEmail = sendConsultantApprovedEmail;
/**
 * Send consultant rejection email
 * @param data - Consultant rejection data
 * @returns Promise<EmailResponse>
 */
const sendConsultantRejectedEmail = async (data) => {
    try {
...
exports.sendConsultantRejectedEmail = sendConsultantRejectedEmail;
/**
 * Send client welcome email
 * @param data - Client welcome data
 * @returns Promise<EmailResponse>
 */
const sendClientWelcomeEmail = async (data) => {
    try {
 ...
 * @returns Promise<EmailResponse>
 */
const sendRefundNotificationEmail = async (data) => {
    try {
        const recipient = data.clientEmail || data.consultantEmail;
        if (!recipient) {
            throw new Error('No recipient email provided');
...
exports.default = {
    ...
    sendConsultantWelcomeEmail: exports.sendConsultantWelcomeEmail,
    sendPasswordResetEmail: exports.sendPasswordResetEmail,
    sendConsultantApprovedEmail: exports.sendConsultantApprovedEmail,
    sendConsultantRejectedEmail: exports.sendConsultantRejectedEmail,
    // Session emails (new)
    sendSessionConfirmationEmail: exports.sendSessionConfirmationEmail,
    // Admin emails (new)
    sendAdminNotificationEmail: exports.sendAdminNotificationEmail,
    // Client emails (new)
    sendClientWelcomeEmail: exports.sendClientWelcomeEmail,
    // Payment emails (new)
