...
exports.validateAccessToken = exports.testMeetingService = exports.generateOAuthURL = exports.sendMeetingInvitation = exports.getMeetingInfo = exports.cancelMeeting = exports.updateMeeting = exports.generateMeetingLink = exports.generateTeamsMeeting = void 0;
 ...
 */
const sendMeetingInvitation = async (meetingDetails, meetingLink, accessToken) => {
    try {
        // Validate access token first
        const isTokenValid = await validateAccessToken(accessToken);
        if (!isTokenValid) {
        ...
        await axios_1.default.post('https://graph.microsoft.com/v1.0/me/events', eventPayload, {
            headers: {
                'Authorization': `Bearer ${accessToken}`,
                'Content-Type': 'application/json'
            },
